...
{
    public class RainbowStorm : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true;
            Item.mana = 10;
            Item.shoot = Mod.Find<ModProjectile>("RainbowStormProjectile").Type;
            //Item.shoot = 79;
            //Item.shoot = ModContent.ProjectileType<RainbowStormProjectile>();
        }
