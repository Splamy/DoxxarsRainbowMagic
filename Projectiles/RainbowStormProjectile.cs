...
{
    internal class RainbowStormProjectile : ModProjectile
    {
        ...
        /// </summary>
            ...
            {
                //DisplayName.SetDefault("RainbowStormbolt");
            }
            ...
            {
                Vector2 launchVelocity = new Vector2(-2, 2); // Create a velocity moving the left.
                for (int i = 0; i < 5; i++)
                {
                    ...
                    Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity, 79, Projectile.damage / 2, Projectile.knockBack, Projectile.owner);
                }
            }
